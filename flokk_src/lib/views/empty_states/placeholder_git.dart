...
class GitPlaceholder extends StatelessWidget {
  ...
  const GitPlaceholder(
      {Key? key, this.isTrending = false, required this.contact})
      : super(key: key);
    ...
    return LayoutBuilder(
      builder: (_, constraints) =>
        ...
        if (constraints.maxHeight > 250)
          PlaceholderImageAndBgStack("dashboard-github",
              height: 126, top: 43, left: -30),
        EmptyStateTitleAndClickableText(
          ...
          endText:
              " to show ${isTrending ? "trending repos" : "recent activity"}",

...
class TopContactsPlaceholder extends StatelessWidget {
  ...
  const TopContactsPlaceholder({Key? key, this.isRecent = false})
      : super(key: key);
      ...
      builder: (_, constraints) {
        ...
        return Row(
          ...
          children: [
            if (showImage) ...{
              isRecent
                  ? PlaceholderImageAndBgStack("dashboard-recentActive",
                      height: 157, top: 2)
                  : PlaceholderImageAndBgStack("dashboard-favorites",
                      height: 126, top: 22),
              HSpace(Insets.xl),
            },
            EmptyStateTitleAndClickableText(
              ...
              startText:
                  "${isRecent ? "Add GitHub and Twitter handles in " : "Star "}",
              linkText: "contacts",
              endText: " to show their recent activity",
              onPressed: () => showContactPage(context),
              crossAxisAlign: showImage
